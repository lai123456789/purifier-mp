...
// 当前用户是否已申请试用  new
const getIsApplyF = (fun) => packagePromise((resolve, reject) => {
  request({
    url: getIsApply(),
    method: 'GET'
  }, fun)
...
// 首页 => 获取图文详情  new
const apigetIntroduceF = (fun) => packagePromise((resolve, reject) => {
  request({
    url: apigetIntroduce(),
    method: 'GET'
  }, fun)
...
// 获取申请成功结果 试用排队人数
const getApplyResultF = (data, fun) => packagePromise((resolve, reject) => {
  let url = getApplyResult();
  request({
    url: url,
    method: 'GET',
    data
